...
const styles = StyleSheet.create({
  ...
  infoPanelName: { fontSize: FONT_SIZES.bodyLarge, fontWeight: '800' },
  infoPanelDesc: { color: COLORS.textMuted, fontSize: FONT_SIZES.caption },
  statsRow: { flexDirection: 'row', justifyContent: 'space-around' },
  statItem: { alignItems: 'center', gap: 2 },
  statLabel: { color: COLORS.textMuted, fontSize: 10, fontWeight: '700', letterSpacing: 1 },
  statValue: { fontSize: FONT_SIZES.small, fontWeight: '700', fontVariant: ['tabular-nums'] },
  ...
  nearbyInfo: { flex: 1 },
  nearbyName: { color: COLORS.textPrimary, fontSize: FONT_SIZES.small, fontWeight: '700' },
  ...
  catalogTitle: { color: COLORS.textPrimary, fontSize: FONT_SIZES.heading, fontWeight: '700', marginBottom: 4 },
  catalogSub: { color: COLORS.textMuted, fontSize: FONT_SIZES.small, marginBottom: SPACING.md },
  ...
  catalogName: { fontSize: FONT_SIZES.bodyLarge, fontWeight: '700' },
  catalogDesc: { color: COLORS.textSecondary, fontSize: FONT_SIZES.small },
