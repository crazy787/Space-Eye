...
const styles = StyleSheet.create({
  ...
  topicTitle: { fontSize: FONT_SIZES.bodyLarge, fontWeight: '800' },
  topicShort: { color: COLORS.textSecondary, fontSize: FONT_SIZES.caption, marginTop: 2 },
  ...
  miniStatValue: { fontSize: FONT_SIZES.small, fontWeight: '800' },
  miniStatLabel: { color: COLORS.textMuted, fontSize: 10, marginTop: 2 },
  routineHeader: { marginBottom: SPACING.md },
  routineTitle: { color: COLORS.textPrimary, fontSize: FONT_SIZES.heading, fontWeight: '700' },
  routineSub: { color: COLORS.textMuted, fontSize: FONT_SIZES.small },
  ...
  routineLabel: { color: COLORS.textPrimary, fontSize: FONT_SIZES.small, fontWeight: '600', flex: 1 },
  ...
  modalTitle: { fontSize: FONT_SIZES.heading, fontWeight: '800', marginBottom: 10 },
  modalDetail: { color: COLORS.textSecondary, fontSize: FONT_SIZES.small, lineHeight: 22, marginBottom: SPACING.md },
  ...
  effectValue: { fontSize: FONT_SIZES.bodyLarge, fontWeight: '800' },
  ...
  askAiText: { fontWeight: '700', fontSize: FONT_SIZES.small },
});
