...
const styles = StyleSheet.create({
  ...
  tourHintText: { color: COLORS.textMuted, fontSize: FONT_SIZES.xs },
  modulesContainer: { paddingHorizontal: SPACING.md, paddingBottom: 40 },
  sectionTitle: { color: COLORS.textPrimary, fontSize: FONT_SIZES.xl, fontWeight: '700', marginBottom: 4 },
  sectionSub: { color: COLORS.textMuted, fontSize: FONT_SIZES.sm, marginBottom: SPACING.md },
  issSchematic: {
  ...
  moduleAgency: { color: COLORS.textMuted, fontSize: FONT_SIZES.xs, fontWeight: '700', letterSpacing: 1 },
  moduleName: { color: COLORS.textPrimary, fontSize: FONT_SIZES.md, fontWeight: '700', marginBottom: 4 },
  moduleDesc: { color: COLORS.textSecondary, fontSize: FONT_SIZES.sm, lineHeight: 18 },
  moduleLearnMore: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 8 },
  learnMoreText: { fontSize: FONT_SIZES.sm, fontWeight: '600' },
  ...
  factInfo: { flex: 1 },
  factLabel: { color: COLORS.textMuted, fontSize: FONT_SIZES.xs, fontWeight: '700', letterSpacing: 1 },
  factValue: { color: COLORS.primary, fontSize: FONT_SIZES.lg, fontWeight: '800' },
  factSub: { color: COLORS.textSecondary, fontSize: FONT_SIZES.xs },
  modalOverlay: {
  ...
  modalTitle: { color: COLORS.textPrimary, fontSize: FONT_SIZES.xl, fontWeight: '800' },
  modalAgency: { color: COLORS.textMuted, fontSize: FONT_SIZES.sm, marginBottom: 12, letterSpacing: 1 },
  modalDescription: { color: COLORS.textSecondary, fontSize: FONT_SIZES.sm, lineHeight: 22, marginBottom: 16 },
  ...
  modalFactText: { color: COLORS.textSecondary, fontSize: FONT_SIZES.sm },
  modalTourBtn: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    gap: 8, paddingVertical: 12, borderRadius: 12, borderWidth: 1,
  },
  modalTourBtnText: { fontWeight: '700', fontSize: FONT_SIZES.sm },
});
