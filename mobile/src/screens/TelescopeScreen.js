...
const styles = StyleSheet.create({
  ...
  detailName: { fontSize: FONT_SIZES.lg, fontWeight: '800' },
  ...
  detailStatValue: { color: COLORS.textPrimary, fontSize: FONT_SIZES.sm, fontWeight: '600', marginTop: 2 },
  ...
  planetName: { fontSize: FONT_SIZES.md, fontWeight: '800' },
  planetDesc: { color: COLORS.textSecondary, fontSize: FONT_SIZES.xs },
  planetDistance: { alignItems: 'flex-end' },
  planetDistValue: { color: COLORS.textPrimary, fontSize: FONT_SIZES.sm, fontWeight: '700' },
  ...
  planetFactText: { color: COLORS.textSecondary, fontSize: FONT_SIZES.sm, flex: 1 },
});
