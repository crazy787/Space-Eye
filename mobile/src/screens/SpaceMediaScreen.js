...
const styles = StyleSheet.create({
  ...
  feedName: { fontSize: FONT_SIZES.bodyLarge, fontWeight: '700' },
  ...
  feedDesc: { color: COLORS.textSecondary, fontSize: FONT_SIZES.small, marginTop: 4, lineHeight: 18 },
  ...
  feedActionText: { fontSize: FONT_SIZES.small, fontWeight: '700', flex: 1 },
  quickLinksTitle: { color: COLORS.textPrimary, fontSize: FONT_SIZES.bodyLarge, fontWeight: '700', marginTop: SPACING.md, marginBottom: SPACING.sm },
  ...
  apodTitle: { color: COLORS.textPrimary, fontSize: FONT_SIZES.title, fontWeight: '800', marginBottom: 4 },
  apodDate: { color: COLORS.primary, fontSize: FONT_SIZES.small, fontWeight: '600', marginBottom: 4 },
  apodCopy: { color: COLORS.textMuted, fontSize: FONT_SIZES.caption, marginBottom: 8 },
  apodExpl: { color: COLORS.textSecondary, fontSize: FONT_SIZES.small, lineHeight: 22 },
  ...
  emptyText: { color: COLORS.textMuted, fontSize: FONT_SIZES.small, textAlign: 'center', maxWidth: 240 },
