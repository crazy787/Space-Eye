...
const styles = StyleSheet.create({
  ...
  missionName: { fontSize: FONT_SIZES.sm, fontWeight: '700' },
  missionAgency: { color: COLORS.textMuted, fontSize: FONT_SIZES.xs },
  simArena: {
  ...
  dockText: { color: '#00e5ff', fontSize: FONT_SIZES.xs, fontWeight: '700', marginTop: 4 },
  progressContainer: {
  ...
  phaseText: { fontSize: FONT_SIZES.xs, fontWeight: '700', letterSpacing: 1.5 },
  stageName: { color: COLORS.textPrimary, fontSize: FONT_SIZES.md, fontWeight: '700' },
  stageDesc: { color: COLORS.textSecondary, fontSize: FONT_SIZES.sm, marginTop: 4 },
  stageProgress: { color: COLORS.textMuted, fontSize: FONT_SIZES.xs, marginTop: 6, textAlign: 'right' },
  completedCard: { alignItems: 'center' },
  completedIcon: { fontSize: 40, marginBottom: 8 },
  completedTitle: { color: COLORS.textPrimary, fontSize: FONT_SIZES.xl, fontWeight: '800' },
  completedSub: { color: COLORS.textMuted, fontSize: FONT_SIZES.sm, marginBottom: 12 },
  replayBtn: {
    flexDirection: 'row', alignItems: 'center', gap: 6,
    paddingHorizontal: 16, paddingVertical: 8,
    borderRadius: 12, borderWidth: 1,
  },
  replayText: { fontWeight: '700', fontSize: FONT_SIZES.sm },
  ...
  launchBtnText: { fontSize: FONT_SIZES.md, fontWeight: '800', letterSpacing: 2 },
});
